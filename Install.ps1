<#
.SYNOPSIS
    One-click installer and launcher for Intune Win32 App Detection Rule Validator
...
Write-Host "    Intune Win32 App Detection Rule Validator" -ForegroundColor Cyan
...
$mainScript = Join-Path $scriptDir "scripts/intune-win32-app-version-aware-detection.ps1"
